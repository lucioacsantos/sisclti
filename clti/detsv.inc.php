...
$pess_clti->ordena = 'ORDER BY data_entra_servico ASC';
...
if ($act == 'cad') {
    ...
    if ($param){
        ...
        $servico = (object)['idtb_det_serv'=>'','sup_servico'=>'','data_entra_servico'=>'',
            ...
            <main>
                <div id=\"form-cadastro\">
                    <form id=\"insertom\" action=\"?cmd=relservico&act=insert\" method=\"post\" enctype=\"multipart/form-data\">
                        <fieldset>
                            ...
                            <div class=\"form-group\">
                                ...
                                <select id=\"sup_entra_servico\" class=\"form-control\" name=\"sup_entra_servico\">
                                        <option value=\"$servico->sup_entra_servico\" selected>
                        ...
                        <input id=\"idtb_rel_servico\" name=\"idtb_rel_servico\" value=\"$servico->idtb_rel_servico\" type=\"hidden\">
