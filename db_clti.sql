...
--
-- TOC entry 3240 (class 1262 OID 16594)
...
--
-- TOC entry 230 (class 1259 OID 16991)
...
--
-- TOC entry 247 (class 1259 OID 25684)
...
--
-- TOC entry 246 (class 1259 OID 25682)
...
--
-- TOC entry 253 (class 1259 OID 25781)
-- Name: tb_funcoes_ti; Type: TABLE; Schema: db_clti; Owner: postgres
--
...
-- Name: tb_funcao_ti_idtb_funcao_ti_seq; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--

CREATE SEQUENCE db_clti.tb_funcao_ti_idtb_funcao_ti_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE db_clti.tb_funcao_ti_idtb_funcao_ti_seq OWNER TO postgres;

--
-- TOC entry 3261 (class 0 OID 0)
-- Dependencies: 252
-- Name: tb_funcao_ti_idtb_funcao_ti_seq; Type: SEQUENCE OWNED BY; Schema: db_clti; Owner: postgres
--

ALTER SEQUENCE db_clti.tb_funcao_ti_idtb_funcao_ti_seq OWNED BY db_clti.tb_funcoes_ti.idtb_funcoes_ti;


--
-- TOC entry 212 (class 1259 OID 16653)
-- Name: tb_lotacao_clti_idtb_lotacao_clti_sequence; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--

CREATE SEQUENCE db_clti.tb_lotacao_clti_idtb_lotacao_clti_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE db_clti.tb_lotacao_clti_idtb_lotacao_clti_sequence OWNER TO postgres;

--
-- TOC entry 213 (class 1259 OID 16655)
-- Name: tb_lotacao_clti; Type: TABLE; Schema: db_clti; Owner: sisclti
--

CREATE TABLE db_clti.tb_lotacao_clti (
    idtb_lotacao_clti integer DEFAULT nextval('db_clti.tb_lotacao_clti_idtb_lotacao_clti_sequence'::regclass) NOT NULL,
...
-- Dependencies: 213
-- Name: TABLE tb_lotacao_clti; Type: COMMENT; Schema: db_clti; Owner: sisclti
--
...
-- Name: tb_om_apoiadas; Type: TABLE; Schema: db_clti; Owner: sisclti
--
...
-- Dependencies: 215
-- Name: TABLE tb_om_apoiadas; Type: COMMENT; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 241 (class 1259 OID 25618)
-- Name: tb_proc_fab; Type: TABLE; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 240 (class 1259 OID 25616)
-- Name: tb_proc_fab_idtb_proc_fab_seq; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--

CREATE SEQUENCE db_clti.tb_proc_fab_idtb_proc_fab_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE db_clti.tb_proc_fab_idtb_proc_fab_seq OWNER TO postgres;

--
-- TOC entry 3274 (class 0 OID 0)
-- Dependencies: 240
-- Name: tb_proc_fab_idtb_proc_fab_seq; Type: SEQUENCE OWNED BY; Schema: db_clti; Owner: postgres
--

ALTER SEQUENCE db_clti.tb_proc_fab_idtb_proc_fab_seq OWNED BY db_clti.tb_proc_fab.idtb_proc_fab;


--
-- TOC entry 243 (class 1259 OID 25626)
-- Name: tb_proc_modelo; Type: TABLE; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 242 (class 1259 OID 25624)
-- Name: tb_proc_modelo_idtb_proc_modelo_seq; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--

CREATE SEQUENCE db_clti.tb_proc_modelo_idtb_proc_modelo_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE db_clti.tb_proc_modelo_idtb_proc_modelo_seq OWNER TO postgres;

--
-- TOC entry 3275 (class 0 OID 0)
-- Dependencies: 242
-- Name: tb_proc_modelo_idtb_proc_modelo_seq; Type: SEQUENCE OWNED BY; Schema: db_clti; Owner: postgres
--

ALTER SEQUENCE db_clti.tb_proc_modelo_idtb_proc_modelo_seq OWNED BY db_clti.tb_proc_modelo.idtb_proc_modelo;


--
-- TOC entry 238 (class 1259 OID 25597)
-- Name: tb_qualificacao_clti; Type: TABLE; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 237 (class 1259 OID 25595)
-- Name: tb_qualificacao_clti_idtb_qualificacao_clti_seq; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--

CREATE SEQUENCE db_clti.tb_qualificacao_clti_idtb_qualificacao_clti_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE db_clti.tb_qualificacao_clti_idtb_qualificacao_clti_seq OWNER TO postgres;

--
-- TOC entry 3276 (class 0 OID 0)
-- Dependencies: 237
-- Name: tb_qualificacao_clti_idtb_qualificacao_clti_seq; Type: SEQUENCE OWNED BY; Schema: db_clti; Owner: postgres
--

ALTER SEQUENCE db_clti.tb_qualificacao_clti_idtb_qualificacao_clti_seq OWNED BY db_clti.tb_qualificacao_clti.idtb_qualificacao_clti;
...
--
-- TOC entry 232 (class 1259 OID 25326)
...
--
-- TOC entry 231 (class 1259 OID 25324)
...
--
-- TOC entry 245 (class 1259 OID 25675)
-- Name: tb_servidores; Type: TABLE; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 244 (class 1259 OID 25673)
-- Name: tb_servidores_idtb_servidores_seq; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--
...
ALTER TABLE db_clti.tb_servidores_idtb_servidores_seq OWNER TO postgres;

--
-- TOC entry 3281 (class 0 OID 0)
-- Dependencies: 244
-- Name: tb_servidores_idtb_servidores_seq; Type: SEQUENCE OWNED BY; Schema: db_clti; Owner: postgres
--
...
CREATE TABLE db_clti.tb_tipos_clti (
    idtb_tipos_clti integer DEFAULT nextval('db_clti.tb_tipos_clti_idtipos_clti_sequence'::regclass) NOT NULL,
...
--
-- TOC entry 235 (class 1259 OID 25482)
...
CREATE VIEW db_clti.vw_admin AS
 SELECT adm.idtb_admin,
    ...
    adm.idtb_corpo_quadro,
    corpo.sigla AS sigla_corpo_quadro,
    adm.idtb_especialidade,
  ...
  WHERE ((adm.idtb_posto_grad = posto.idtb_posto_grad) AND (adm.idtb_corpo_quadro = corpo.idtb_corpo_quadro) AND (adm.idtb_especialidade = espec.idtb_especialidade) AND (adm.idtb_om_apoiadas = om.idtb_om_apoiadas));


ALTER TABLE db_clti.vw_admin OWNER TO postgres;

--
-- TOC entry 249 (class 1259 OID 25703)
-- Name: vw_conectividade; Type: VIEW; Schema: db_clti; Owner: postgres
--

CREATE VIEW db_clti.vw_conectividade AS
...
ALTER TABLE db_clti.vw_conectividade OWNER TO postgres;

--
-- TOC entry 250 (class 1259 OID 25737)
-- Name: vw_estacoes; Type: VIEW; Schema: db_clti; Owner: postgres
--

CREATE VIEW db_clti.vw_estacoes AS
 SELECT et.idtb_estacoes,
    et.idtb_om_apoiadas,
    et.idtb_proc_modelo,
    et.clock_proc,
    et.fabricante,
...
ALTER TABLE db_clti.vw_estacoes OWNER TO postgres;

--
-- TOC entry 233 (class 1259 OID 25434)
...
--
-- TOC entry 254 (class 1259 OID 25803)
...
--
-- TOC entry 248 (class 1259 OID 25695)
-- Name: vw_processadores; Type: VIEW; Schema: db_clti; Owner: postgres
--

CREATE VIEW db_clti.vw_processadores AS
 SELECT fab.idtb_proc_fab,
...
--
-- TOC entry 239 (class 1259 OID 25611)
-- Name: vw_qualificacao_clti; Type: VIEW; Schema: db_clti; Owner: sisclti
--

CREATE VIEW db_clti.vw_qualificacao_clti AS
 SELECT quali.idtb_qualificacao_clti,
...
--
-- TOC entry 236 (class 1259 OID 25565)
-- Name: vw_qualificacao_pesti; Type: VIEW; Schema: db_clti; Owner: postgres
--

CREATE VIEW db_clti.vw_qualificacao_pesti AS
 SELECT quali.idtb_qualificacao_ti,
...
--
-- TOC entry 251 (class 1259 OID 25770)
-- Name: vw_servidores; Type: VIEW; Schema: db_clti; Owner: postgres
--

CREATE VIEW db_clti.vw_servidores AS
 SELECT srv.idtb_servidores,
...
ALTER TABLE db_clti.vw_servidores OWNER TO postgres;

--
-- TOC entry 2962 (class 2604 OID 16994)
...
--
-- TOC entry 2947 (class 2604 OID 16693)
...
--
-- TOC entry 2968 (class 2604 OID 25687)
...
--
-- TOC entry 2969 (class 2604 OID 25784)
-- Name: tb_funcoes_ti idtb_funcoes_ti; Type: DEFAULT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_funcoes_ti ALTER COLUMN idtb_funcoes_ti SET DEFAULT nextval('db_clti.tb_funcao_ti_idtb_funcao_ti_seq'::regclass);


--
-- TOC entry 2960 (class 2604 OID 16909)
...
--
-- TOC entry 2957 (class 2604 OID 16694)
...
--
-- TOC entry 2965 (class 2604 OID 25621)
-- Name: tb_proc_fab idtb_proc_fab; Type: DEFAULT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_proc_fab ALTER COLUMN idtb_proc_fab SET DEFAULT nextval('db_clti.tb_proc_fab_idtb_proc_fab_seq'::regclass);


--
-- TOC entry 2966 (class 2604 OID 25629)
-- Name: tb_proc_modelo idtb_proc_modelo; Type: DEFAULT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_proc_modelo ALTER COLUMN idtb_proc_modelo SET DEFAULT nextval('db_clti.tb_proc_modelo_idtb_proc_modelo_seq'::regclass);


--
-- TOC entry 2964 (class 2604 OID 25600)
-- Name: tb_qualificacao_clti idtb_qualificacao_clti; Type: DEFAULT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_qualificacao_clti ALTER COLUMN idtb_qualificacao_clti SET DEFAULT nextval('db_clti.tb_qualificacao_clti_idtb_qualificacao_clti_seq'::regclass);


--
-- TOC entry 2961 (class 2604 OID 16940)
...
--
-- TOC entry 2963 (class 2604 OID 25329)
...
--
-- TOC entry 2967 (class 2604 OID 25678)
-- Name: tb_servidores idtb_servidores; Type: DEFAULT; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 2959 (class 2604 OID 16814)
...
--
-- TOC entry 3191 (class 0 OID 16604)
-- Dependencies: 201
-- Data for Name: tb_admin; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_admin (idtb_admin, idtb_om_apoiadas, idtb_posto_grad, idtb_corpo_quadro, idtb_especialidade, nip, cpf, nome, nome_guerra, perfil, senha, status, correio_eletronico) FROM stdin;
\.


--
-- TOC entry 3192 (class 0 OID 16619)
-- Dependencies: 202
...
--
-- TOC entry 3194 (class 0 OID 16625)
-- Dependencies: 204
...
--
-- TOC entry 3220 (class 0 OID 16991)
-- Dependencies: 230
...
--
-- TOC entry 3195 (class 0 OID 16629)
-- Dependencies: 205
...
--
-- TOC entry 3198 (class 0 OID 16639)
-- Dependencies: 208
...
--
-- TOC entry 3200 (class 0 OID 16645)
-- Dependencies: 210
...
--
-- TOC entry 3232 (class 0 OID 25684)
-- Dependencies: 247
...
--
-- TOC entry 3201 (class 0 OID 16649)
-- Dependencies: 211
...
--
-- TOC entry 3234 (class 0 OID 25781)
-- Dependencies: 253
-- Data for Name: tb_funcoes_ti; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_funcoes_ti (idtb_funcoes_ti, descricao, sigla) FROM stdin;
...
--
-- TOC entry 3203 (class 0 OID 16655)
-- Dependencies: 213
...
--
-- TOC entry 3205 (class 0 OID 16665)
-- Dependencies: 215
...
--
-- TOC entry 3207 (class 0 OID 16671)
-- Dependencies: 217
-- Data for Name: tb_osic; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_osic (idtb_osic, idtb_om_apoiadas, idtb_posto_grad, idtb_corpo_quadro, idtb_especialidade, nip, cpf, nome, nome_guerra, perfil, senha, status, correio_eletronico) FROM stdin;
\.


--
-- TOC entry 3208 (class 0 OID 16675)
-- Dependencies: 218
...
--
-- TOC entry 3216 (class 0 OID 16906)
-- Dependencies: 226
...
--
-- TOC entry 3209 (class 0 OID 16679)
-- Dependencies: 219
...
--
-- TOC entry 3226 (class 0 OID 25618)
-- Dependencies: 241
-- Data for Name: tb_proc_fab; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_proc_fab (idtb_proc_fab, nome) FROM stdin;
3	INTEL
4	AMD
\.
...
--
-- TOC entry 3228 (class 0 OID 25626)
-- Dependencies: 243
-- Data for Name: tb_proc_modelo; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_proc_modelo (idtb_proc_modelo, idtb_proc_fab, modelo) FROM stdin;
1	3	CELERON
3	3	CORE 2 DUO
4	3	Core 2 Extreme
5	3	Core 2 Quad
6	3	Pentium 4
7	3	Pentium D
8	3	Pentium Dual Core
9	3	Pentium Extreme
10	3	Xeon
11	3	Core i3
12	3	Core i5
13	3	Core i7
14	3	Core i7 Extreme Edition
15	4	Athlon 64
16	4	Athlon FX
17	4	AthlonX2
18	4	Dual-core Opteron
19	4	Sempron
20	4	Sempron X2
21	4	Athlon X2
22	4	Phenom
...
26	4	Phenom II X6
27	4	Athlon II
28	4	Dual-Core A4 3300
29	4	Dual-Core A4 3400
30	4	Triple-Core A6 3500
31	4	Quad-core A6 3650
32	4	Quad-core A6 3650K Black Edition
33	4	Quad-core A8 3850
34	4	Quad-core A8 3870K Black Edition
35	4	Dual-Core A4 4000
36	4	Dual-Core 5300
37	4	Dual-Core 6300
38	4	Dual-Core A6 5400K
39	4	Quad-Core A8 5500
40	4	Quad-Core A8 5600K
41	4	Quad-Core A8 6500
42	4	Quad-Core A8 6600K
43	4	Quad-Core A10 5700
44	4	Quad-Core A8 6700
45	4	Quad-Core A8 5800K
46	4	Quad-Core A8 6790K
47	4	Quad-Core A8 6800K
\.


--
-- TOC entry 3224 (class 0 OID 25597)
-- Dependencies: 238
-- Data for Name: tb_qualificacao_clti; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 3218 (class 0 OID 16937)
-- Dependencies: 228
...
--
-- TOC entry 3222 (class 0 OID 25326)
-- Dependencies: 232
-- Data for Name: tb_registro_log; Type: TABLE DATA; Schema: db_clti; Owner: sisclti
--

COPY db_clti.tb_registro_log (idtb_registro_log, data_acao, acao, nip_cps_resp) FROM stdin;
\.


--
-- TOC entry 3230 (class 0 OID 25675)
-- Dependencies: 245
-- Data for Name: tb_servidores; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 3214 (class 0 OID 16811)
-- Dependencies: 224
...
19	MICROSOFT	WINDOWS	XP	DESCONTINUADO
17	MICROSOFT	WINDOWS	7	DESCONTINUADO
18	MICROSOFT	WINDOWS	8	DESCONTINUADO
20	MICROSOFT	WINDOWS	8.1	ATIVO
21	MICROSOFT	WINDOWS	10	ATIVO
22	MICROSOFT	WINDOWS SERVER	2000	DESCONTINUADO
23	MICROSOFT	WINDOWS SERVER	2003	DESCONTINUADO
24	MICROSOFT	WINDOWS SERVER	2008	DESCONTINUADO
25	MICROSOFT	WINDOWS SERVER	2012	ATIVO
26	MICROSOFT	WINDOWS SERVER	2016	ATIVO
27	MICROSOFT	WINDOWS SERVER	2019	ATIVO
28	CANONICAL	UBUNTU MB	14.04	DESCONTINUADO
29	CANONICAL	UBUNTU MB	16.04	ATIVO
30	CANONICAL	UBUNTU MB	18.04	ATIVO
31	CANONICAL	UBUNTU MB	20.04	ATIVO
33	CITRIX	HYPERVISOR XENSERVER	7.0	ATIVO
34	CITRIX	HYPERVISOR XENSERVER	7.1	ATIVO
35	CITRIX	HYPERVISOR XENSERVER	8.0	ATIVO
36	CITRIX	HYPERVISOR XENSERVER	8.1	ATIVO
37	VMWARE	VMWARE ESXI	5.5	DESCONTINUADO
38	VMWARE	VMWARE ESXI	6.0	ATIVO
32	VMWARE	VMWARE ESXI	6.7	ATIVO
39	VMWARE	VMWARE ESXI	6.5	ATIVO
40	VMWARE	VMWARE ESXI	7.0	ATIVO
41	ORACLE	ORACLE LINUX	7	ATIVO
\.


--
-- TOC entry 3212 (class 0 OID 16688)
-- Dependencies: 222
-- Data for Name: tb_tipos_clti; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_tipos_clti (idtb_tipos_clti, norma_atual, data_norma, lotacao_oficiais, lotacao_pracas, tipo_clti) FROM stdin;
17	DCTIMARINST 30-06C	2019-04-30	1	1	1
\.
...
SELECT pg_catalog.setval('db_clti.tb_admin_idtb_admin_sequence', 2, true);
...
SELECT pg_catalog.setval('db_clti.tb_conectividade_idtb_conectividade_seq', 3, true);
...
-- Dependencies: 252
-- Name: tb_funcao_ti_idtb_funcao_ti_seq; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_funcao_ti_idtb_funcao_ti_seq', 4, true);


--
-- TOC entry 3297 (class 0 OID 0)
-- Dependencies: 212
-- Name: tb_lotacao_clti_idtb_lotacao_clti_sequence; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_lotacao_clti_idtb_lotacao_clti_sequence', 2, true);
...
SELECT pg_catalog.setval('db_clti.tb_om_apoiadas_idtb_om_apoiadas_sequence', 9, true);
...
SELECT pg_catalog.setval('db_clti.tb_osic_idtb_osic_sequence', 6, true);
...
SELECT pg_catalog.setval('db_clti.tb_pessoal_ti_idtb_pessoal_ti_seq', 12, true);
...
-- Dependencies: 240
-- Name: tb_proc_fab_idtb_proc_fab_seq; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_proc_fab_idtb_proc_fab_seq', 4, true);


--
-- TOC entry 3303 (class 0 OID 0)
-- Dependencies: 242
-- Name: tb_proc_modelo_idtb_proc_modelo_seq; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_proc_modelo_idtb_proc_modelo_seq', 47, true);


--
-- TOC entry 3304 (class 0 OID 0)
-- Dependencies: 237
-- Name: tb_qualificacao_clti_idtb_qualificacao_clti_seq; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_qualificacao_clti_idtb_qualificacao_clti_seq', 1, true);
...
SELECT pg_catalog.setval('db_clti.tb_qualificacao_ti_idtb_qualificacao_ti_seq', 2, true);
...
-- Dependencies: 244
-- Name: tb_servidores_idtb_servidores_seq; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_servidores_idtb_servidores_seq', 1, true);
...
SELECT pg_catalog.setval('db_clti.tb_sor_idtb_sor_seq', 41, true);
...
SELECT pg_catalog.setval('db_clti.tb_tipos_clti_idtipos_clti_sequence', 17, true);


--
-- TOC entry 2973 (class 2606 OID 16696)
...
--
-- TOC entry 2983 (class 2606 OID 16698)
...
--
-- TOC entry 2998 (class 2606 OID 16700)
...
--
-- TOC entry 2971 (class 2606 OID 16704)
...
--
-- TOC entry 2975 (class 2606 OID 16706)
...
--
-- TOC entry 3010 (class 2606 OID 17012)
...
--
-- TOC entry 3012 (class 2606 OID 16999)
...
--
-- TOC entry 2977 (class 2606 OID 16708)
...
--
-- TOC entry 2979 (class 2606 OID 16710)
...
--
-- TOC entry 2981 (class 2606 OID 16712)
...
--
-- TOC entry 3028 (class 2606 OID 25786)
-- Name: tb_funcoes_ti tb_funcao_ti_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_funcoes_ti
    ADD CONSTRAINT tb_funcao_ti_pkey PRIMARY KEY (idtb_funcoes_ti);


--
-- TOC entry 2992 (class 2606 OID 16714)
-- Name: tb_om_apoiadas tb_om_apoiadas_cod_om_nome_sigla_indicativo_key; Type: CONSTRAINT; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 2994 (class 2606 OID 16716)
-- Name: tb_om_apoiadas tb_om_apoiadas_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 2996 (class 2606 OID 16718)
...
--
-- TOC entry 3006 (class 2606 OID 16983)
...
--
-- TOC entry 3000 (class 2606 OID 16720)
...
--
-- TOC entry 3018 (class 2606 OID 25702)
-- Name: tb_proc_fab tb_proc_fab_nome_key; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_proc_fab
    ADD CONSTRAINT tb_proc_fab_nome_key UNIQUE (nome);


--
-- TOC entry 3020 (class 2606 OID 25623)
-- Name: tb_proc_fab tb_proc_fab_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 3022 (class 2606 OID 25700)
-- Name: tb_proc_modelo tb_proc_modelo_modelo_key; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_proc_modelo
    ADD CONSTRAINT tb_proc_modelo_modelo_key UNIQUE (modelo);


--
-- TOC entry 3024 (class 2606 OID 25631)
-- Name: tb_proc_modelo tb_proc_modelo_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 3016 (class 2606 OID 25605)
-- Name: tb_qualificacao_clti tb_qualificacao_clti_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_qualificacao_clti
    ADD CONSTRAINT tb_qualificacao_clti_pkey PRIMARY KEY (idtb_qualificacao_clti);


--
-- TOC entry 3008 (class 2606 OID 16945)
...
--
-- TOC entry 3014 (class 2606 OID 25331)
...
--
-- TOC entry 3026 (class 2606 OID 25754)
-- Name: tb_servidores tb_servidores_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 3002 (class 2606 OID 16722)
...
--
-- TOC entry 2988 (class 2606 OID 16724)
-- Name: tb_lotacao_clti tb_tripulacao_clti_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 2990 (class 2606 OID 16726)
-- Name: tb_lotacao_clti unico_nip_cpf; Type: CONSTRAINT; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 2984 (class 1259 OID 16727)
-- Name: fki_id_corpo_quadro; Type: INDEX; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 2985 (class 1259 OID 16728)
-- Name: fki_id_especialidade; Type: INDEX; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 2986 (class 1259 OID 16729)
-- Name: fki_id_posto_grad; Type: INDEX; Schema: db_clti; Owner: sisclti
--
...
--
-- TOC entry 3031 (class 2606 OID 25384)
-- Name: tb_admin tb_admin_idtb_corpo_quadro_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin
    ADD CONSTRAINT tb_admin_idtb_corpo_quadro_fkey FOREIGN KEY (idtb_corpo_quadro) REFERENCES db_clti.tb_corpo_quadro(idtb_corpo_quadro) NOT VALID;


--
-- TOC entry 3032 (class 2606 OID 25389)
-- Name: tb_admin tb_admin_idtb_especialidade_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin
    ADD CONSTRAINT tb_admin_idtb_especialidade_fkey FOREIGN KEY (idtb_especialidade) REFERENCES db_clti.tb_especialidade(idtb_especialidade) NOT VALID;


--
-- TOC entry 3029 (class 2606 OID 25374)
-- Name: tb_admin tb_admin_idtb_om_apoiadas_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin
    ADD CONSTRAINT tb_admin_idtb_om_apoiadas_fkey FOREIGN KEY (idtb_om_apoiadas) REFERENCES db_clti.tb_om_apoiadas(idtb_om_apoiadas) NOT VALID;


--
-- TOC entry 3030 (class 2606 OID 25379)
-- Name: tb_admin tb_admin_idtb_posto_grad_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin
    ADD CONSTRAINT tb_admin_idtb_posto_grad_fkey FOREIGN KEY (idtb_posto_grad) REFERENCES db_clti.tb_posto_grad(idtb_posto_grad) NOT VALID;


--
-- TOC entry 3033 (class 2606 OID 17132)
...
--
-- TOC entry 3050 (class 2606 OID 17000)
...
--
-- TOC entry 3034 (class 2606 OID 17137)
...
--
-- TOC entry 3036 (class 2606 OID 25404)
-- Name: tb_lotacao_clti tb_lotacao_clti_idtb_corpo_quadro_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: sisclti
--

ALTER TABLE ONLY db_clti.tb_lotacao_clti
    ADD CONSTRAINT tb_lotacao_clti_idtb_corpo_quadro_fkey FOREIGN KEY (idtb_corpo_quadro) REFERENCES db_clti.tb_corpo_quadro(idtb_corpo_quadro) NOT VALID;


--
-- TOC entry 3037 (class 2606 OID 25409)
-- Name: tb_lotacao_clti tb_lotacao_clti_idtb_especialidade_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: sisclti
--

ALTER TABLE ONLY db_clti.tb_lotacao_clti
    ADD CONSTRAINT tb_lotacao_clti_idtb_especialidade_fkey FOREIGN KEY (idtb_especialidade) REFERENCES db_clti.tb_especialidade(idtb_especialidade) NOT VALID;


--
-- TOC entry 3035 (class 2606 OID 25399)
-- Name: tb_lotacao_clti tb_lotacao_clti_idtb_posto_grad_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: sisclti
--

ALTER TABLE ONLY db_clti.tb_lotacao_clti
    ADD CONSTRAINT tb_lotacao_clti_idtb_posto_grad_fkey FOREIGN KEY (idtb_posto_grad) REFERENCES db_clti.tb_posto_grad(idtb_posto_grad) NOT VALID;


--
-- TOC entry 3038 (class 2606 OID 16775)
-- Name: tb_om_apoiadas tb_om_apoiadas_id_cidade_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: sisclti
--

ALTER TABLE ONLY db_clti.tb_om_apoiadas
    ADD CONSTRAINT tb_om_apoiadas_id_cidade_fkey FOREIGN KEY (idtb_cidade) REFERENCES db_clti.tb_cidade(id);


--
-- TOC entry 3039 (class 2606 OID 16780)
-- Name: tb_om_apoiadas tb_om_apoiadas_id_estado_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: sisclti
--

ALTER TABLE ONLY db_clti.tb_om_apoiadas
    ADD CONSTRAINT tb_om_apoiadas_id_estado_fkey FOREIGN KEY (idtb_estado) REFERENCES db_clti.tb_estado(id);


--
-- TOC entry 3042 (class 2606 OID 25424)
-- Name: tb_osic tb_osic_idtb_corpo_quadro_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_osic
    ADD CONSTRAINT tb_osic_idtb_corpo_quadro_fkey FOREIGN KEY (idtb_corpo_quadro) REFERENCES db_clti.tb_corpo_quadro(idtb_corpo_quadro) NOT VALID;


--
-- TOC entry 3043 (class 2606 OID 25429)
-- Name: tb_osic tb_osic_idtb_especialidade_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_osic
    ADD CONSTRAINT tb_osic_idtb_especialidade_fkey FOREIGN KEY (idtb_especialidade) REFERENCES db_clti.tb_especialidade(idtb_especialidade) NOT VALID;


--
-- TOC entry 3040 (class 2606 OID 25414)
-- Name: tb_osic tb_osic_idtb_om_apoiadas_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_osic
    ADD CONSTRAINT tb_osic_idtb_om_apoiadas_fkey FOREIGN KEY (idtb_om_apoiadas) REFERENCES db_clti.tb_om_apoiadas(idtb_om_apoiadas) NOT VALID;


--
-- TOC entry 3041 (class 2606 OID 25419)
-- Name: tb_osic tb_osic_idtb_posto_grad_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_osic
    ADD CONSTRAINT tb_osic_idtb_posto_grad_fkey FOREIGN KEY (idtb_posto_grad) REFERENCES db_clti.tb_posto_grad(idtb_posto_grad) NOT VALID;


--
-- TOC entry 3046 (class 2606 OID 16972)
...
--
-- TOC entry 3047 (class 2606 OID 16977)
...
--
-- TOC entry 3048 (class 2606 OID 25793)
-- Name: tb_pessoal_ti tb_pessoal_ti_idtb_funcoes_ti_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_pessoal_ti
    ADD CONSTRAINT tb_pessoal_ti_idtb_funcoes_ti_fkey FOREIGN KEY (idtb_funcoes_ti) REFERENCES db_clti.tb_funcoes_ti(idtb_funcoes_ti) NOT VALID;


--
-- TOC entry 3044 (class 2606 OID 16962)
-- Name: tb_pessoal_ti tb_pessoal_ti_idtb_om_apoiada_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_pessoal_ti
    ADD CONSTRAINT tb_pessoal_ti_idtb_om_apoiada_fkey FOREIGN KEY (idtb_om_apoiadas) REFERENCES db_clti.tb_om_apoiadas(idtb_om_apoiadas) NOT VALID;


--
-- TOC entry 3045 (class 2606 OID 16967)
...
--
-- TOC entry 3052 (class 2606 OID 25633)
-- Name: tb_proc_modelo tb_proc_modelo_idtb_proc_fab_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_proc_modelo
    ADD CONSTRAINT tb_proc_modelo_idtb_proc_fab_fkey FOREIGN KEY (idtb_proc_fab) REFERENCES db_clti.tb_proc_fab(idtb_proc_fab) NOT VALID;


--
-- TOC entry 3051 (class 2606 OID 25606)
-- Name: tb_qualificacao_clti tb_qualificacao_clti_idtb_lotacao_clti_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_qualificacao_clti
    ADD CONSTRAINT tb_qualificacao_clti_idtb_lotacao_clti_fkey FOREIGN KEY (idtb_lotacao_clti) REFERENCES db_clti.tb_lotacao_clti(idtb_lotacao_clti) NOT VALID;


--
-- TOC entry 3049 (class 2606 OID 25550)
...
--
-- TOC entry 3053 (class 2606 OID 25755)
-- Name: tb_servidores tb_servidores_idtb_om_apoiadas_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--
...
--
-- TOC entry 3054 (class 2606 OID 25760)
-- Name: tb_servidores tb_servidores_idtb_proc_modelo_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_servidores
    ADD CONSTRAINT tb_servidores_idtb_proc_modelo_fkey FOREIGN KEY (idtb_proc_modelo) REFERENCES db_clti.tb_proc_modelo(idtb_proc_modelo) NOT VALID;


--
-- TOC entry 3055 (class 2606 OID 25765)
-- Name: tb_servidores tb_servidores_idtb_sor_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--
