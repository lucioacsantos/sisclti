...
$pdf->ezText("          Pelo presente instrumento, eu, $postograd $nip_cpf $nome, perante a Marinha do Brasil, doravante denominada MB, na qualidade de usuário do ambiente computacional de propriedade daquela Instituição, declaro estar ciente das normas de segurança das informações digitais da OM, segundo as quais devo:",12, ['justification' => 'full', 'spacing' => 1.5]);
...
x) estar ciente de que a MB poderá auditar as correspondências eletrônicas originadas ou retransmitidas por mim no ambiente computacional da OM. Desta forma, estou ciente da minha responsabilidade pelas conseqüências decorrentes da não observância do acima exposto e da legislação vigente.", 12, ['justification' => 'full', 'spacing' => 1.5]);

$pdf->ezText("\n\n$nome $postograd $nip_cpf", 12, ['justification' => 'center', 'spacing' => 1.5]);
