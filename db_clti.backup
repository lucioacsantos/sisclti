...
-- Started on 2020-05-10 18:21:56 -03
...
-- Name: db_clti; Type: SCHEMA; Schema: -; Owner: postgres
--

CREATE SCHEMA db_clti;


ALTER SCHEMA db_clti OWNER TO postgres;
...
-- Name: tb_admin_om; Type: TABLE; Schema: db_clti; Owner: postgres
--

CREATE TABLE db_clti.tb_admin_om (
    idtb_admin_om integer NOT NULL,
    id_om_apoiada integer NOT NULL,
...
ALTER TABLE db_clti.tb_admin_om OWNER TO postgres;

--
-- TOC entry 209 (class 1259 OID 16405)
-- Name: tb_admin_om_idtb_admin_om_seq; Type: SEQUENCE; Schema: db_clti; Owner: postgres
--

CREATE SEQUENCE db_clti.tb_admin_om_idtb_admin_om_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE db_clti.tb_admin_om_idtb_admin_om_seq OWNER TO postgres;

--
-- TOC entry 3142 (class 0 OID 0)
-- Dependencies: 209
-- Name: tb_admin_om_idtb_admin_om_seq; Type: SEQUENCE OWNED BY; Schema: db_clti; Owner: postgres
--

ALTER SEQUENCE db_clti.tb_admin_om_idtb_admin_om_seq OWNED BY db_clti.tb_admin_om.idtb_admin_om;
...
--
-- TOC entry 2919 (class 2604 OID 16585)
-- Name: tb_admin_om idtb_admin_om; Type: DEFAULT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin_om ALTER COLUMN idtb_admin_om SET DEFAULT nextval('db_clti.tb_admin_om_idtb_admin_om_seq'::regclass);
...
--
-- TOC entry 2931 (class 2604 OID 16587)
...
--
-- TOC entry 3111 (class 0 OID 16395)
-- Dependencies: 207
-- Data for Name: tb_admin; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_admin (idtb_admin, id_om, id_posto_grad, id_corpo_quadro, id_especialidade, nip, cpf, nome, nome_guerra, status) FROM stdin;
\.


--
-- TOC entry 3112 (class 0 OID 16399)
-- Dependencies: 208
-- Data for Name: tb_admin_om; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_admin_om (idtb_admin_om, id_om_apoiada, usuario, senha, perfil, status) FROM stdin;
8	5	ADMIN3DN	b9b4c1c45b77ba67f49349aaaeb6d76984bb57f3	ADMIN_OM	ATIVO
9	5	ADMINCLTI	59a42ff02ba2da38a09d4831bccc9af886957d51	ADMIN_OM	ATIVO
\.


--
-- TOC entry 3114 (class 0 OID 16407)
-- Dependencies: 210
...
--
-- TOC entry 3116 (class 0 OID 16413)
-- Dependencies: 212
...
--
-- TOC entry 3117 (class 0 OID 16417)
-- Dependencies: 213
...
--
-- TOC entry 3120 (class 0 OID 16427)
-- Dependencies: 216
...
--
-- TOC entry 3122 (class 0 OID 16433)
-- Dependencies: 218
...
--
-- TOC entry 3123 (class 0 OID 16437)
-- Dependencies: 219
...
--
-- TOC entry 3125 (class 0 OID 16443)
-- Dependencies: 221
...
18	16	1	8	99242991		LUCIO ALEXANDRE CORREIA DOS SANTOS	ALEXANDRE	ATIVO	8e0d92e98814d1cba96d8848fe709d36f94499ce	TEC_CLTI
20	21	17	22		ADMINCLTI	ADMINCLTI	ADMINCLTI	1	59a42ff02ba2da38a09d4831bccc9af886957d51	TEC_CLTI
\.


--
-- TOC entry 3127 (class 0 OID 16453)
-- Dependencies: 223
...
--
-- TOC entry 3129 (class 0 OID 16459)
-- Dependencies: 225
-- Data for Name: tb_osic; Type: TABLE DATA; Schema: db_clti; Owner: postgres
--

COPY db_clti.tb_osic (idtb_osic, id_om, id_posto_grad, id_corpo_quadro, id_especialidade, nip, cpf, nome, nome_guerra, status) FROM stdin;
\.


--
-- TOC entry 3130 (class 0 OID 16463)
-- Dependencies: 226
...
--
-- TOC entry 3131 (class 0 OID 16467)
-- Dependencies: 227
...
--
-- TOC entry 3135 (class 0 OID 16476)
-- Dependencies: 231
...
SELECT pg_catalog.setval('db_clti.tb_admin_idtb_admin_sequence', 1, true);


--
-- TOC entry 3161 (class 0 OID 0)
-- Dependencies: 209
-- Name: tb_admin_om_idtb_admin_om_seq; Type: SEQUENCE SET; Schema: db_clti; Owner: postgres
--

SELECT pg_catalog.setval('db_clti.tb_admin_om_idtb_admin_om_seq', 9, true);
...
SELECT pg_catalog.setval('db_clti.tb_osic_idtb_osic_sequence', 1, true);
...
--
-- TOC entry 2938 (class 2606 OID 16484)
...
--
-- TOC entry 2948 (class 2606 OID 16486)
...
--
-- TOC entry 2963 (class 2606 OID 16488)
...
--
-- TOC entry 2936 (class 2606 OID 16490)
-- Name: tb_admin_om tb_admin_om_pkey; Type: CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin_om
    ADD CONSTRAINT tb_admin_om_pkey PRIMARY KEY (idtb_admin_om);


--
-- TOC entry 2934 (class 2606 OID 16492)
...
--
-- TOC entry 2942 (class 2606 OID 16496)
...
--
-- TOC entry 2944 (class 2606 OID 16498)
...
--
-- TOC entry 2946 (class 2606 OID 16500)
...
--
-- TOC entry 2959 (class 2606 OID 16504)
...
--
-- TOC entry 2961 (class 2606 OID 16506)
...
--
-- TOC entry 2965 (class 2606 OID 16508)
...
--
-- TOC entry 2967 (class 2606 OID 16510)
...
--
-- TOC entry 2953 (class 2606 OID 16512)
...
--
-- TOC entry 2949 (class 1259 OID 16515)
...
--
-- TOC entry 2950 (class 1259 OID 16516)
...
--
-- TOC entry 2951 (class 1259 OID 16517)
...
--
-- TOC entry 2971 (class 2606 OID 16518)
-- Name: tb_admin_om id_om_fkey; Type: FK CONSTRAINT; Schema: db_clti; Owner: postgres
--

ALTER TABLE ONLY db_clti.tb_admin_om
    ADD CONSTRAINT id_om_fkey FOREIGN KEY (id_om_apoiada) REFERENCES db_clti.tb_om_apoiadas(idtb_om_apoiadas);
...
--
-- TOC entry 2969 (class 2606 OID 16528)
...
--
-- TOC entry 2973 (class 2606 OID 16543)
...
--
-- TOC entry 2974 (class 2606 OID 16548)
...
--
-- TOC entry 2975 (class 2606 OID 16553)
...
--
-- TOC entry 2977 (class 2606 OID 16563)
...
--
-- TOC entry 2979 (class 2606 OID 16573)
...
--
-- TOC entry 2980 (class 2606 OID 16578)
...
-- Completed on 2020-05-10 18:21:56 -03
